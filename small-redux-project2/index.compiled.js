...
var budgetsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    editBudget: function editBudget(state, action) {
      ...
      var budgetToUpdate = state.find(function (budget) {
...
var transactionsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    ...
    deleteTranscation: function deleteTranscation(state, action) {
      var _action$payload = action.payload,
        category = _action$payload.category,
        id = _action$payload.id;
      state[category] = state[category].filter(function (transaction) {
